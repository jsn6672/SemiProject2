		...
		<div class="gh-search">
			<form action="RentShopSearchC">
				<select name="searchOption">
					...
					<option value="addressDoro">주소(도로명)</option>
					<option value="addressJibun">주소(지번)</option>
				</select> <input name="searchText">
				<!-- 	<input type="hidden" name="no" value="${no}">  -->
				<button class="gh-search-button">검색</button>
				<input name="gh_lang" value="kr" hidden="">
			</form>

			<form action="gh_JPC" method="post">
				<button class="gh-translate">日本語</button>
			</form>
