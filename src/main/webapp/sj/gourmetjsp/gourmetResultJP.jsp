...
<body>
	...
	<div class="toolbar">
		<div class="toolbar-info">
			...
			<div class="icon"></div>
			<div class="temp"></div>
			<a href="Main_HC" class="quick_btn">ホーム</a> <br> <a
				href="GourmetC" class="quick_btn">日本語</a> <br>
			<!-- 퀵버튼 -->
	...
	<div class="popup" id="signup">
		<div class="sign_up">
			<h1 class="signup_header">ハロー, 陸地の人 :-)</h1>
			<br>
						...
						<div class="review-div-wrap">
							<c:forEach var="review" items="${g.reviews }">
								<div class="review-div">
									<br>
									<div>評価 : ${review.gm_grade }</div>
									<div>作成日 : ${review.gm_date }</div>
									<div>おすすめ : ${review.gm_menu }</div>
									<div>内容 : ${review.gm_review }</div>
									<br> <br>
		...
		<div class="sj-review-content-write">
			...
			<form action="GourmetReviewC" method="post" id="review-modal-form"
				...
				<table>
					...
					<tr>
						<td>おすすめ</td>
						<td><textarea id="sj-r_menu" name="sj-r_menu" rows="10"
								cols="70"></textarea></td>
					</tr>
					<tr>
						<td>写真</td>
					...
					<tr>
						<td><button id="modal-btn" onclick="sjCloseReviewWrite()">登録する</button></td>
					</tr>
				</table>
			</form>
				...
				.getJSON(
						...
						function(result) {
							...
							function convertTime(t) {
								var week = new Array('日曜日', '月曜日', '火曜日',
										'水曜日', '木曜日', '金曜日', '土曜日');
